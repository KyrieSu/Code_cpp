...
bool Triangle::Valid(){
	...
	float A_C = sqrt(pow((V[2].x - V[0].x), 2) + pow((V[2].y - V[0].y), 2));
	float B_C = sqrt(pow((V[2].x - V[1].x), 2) + pow((V[2].y - V[1].y), 2));
	bool special = ((V[0].x - V[2].x)*(V[1].y - V[2].y) - (V[0].y - V[2].y)*(V[1].x - V[2].x)) != 0;
	return ((A_B + A_C > B_C) && (A_B + B_C > A_C) && (B_C + A_C > A_B)) && special;
}
...
bool Quadrilateral::Valid(){
	return V.size() == 4 && ((V[0].x - V[2].x)*(V[1].y - V[2].y) - (V[0].y - V[2].y)*(V[1].x - V[2].x)) != 0;
}
...
bool Pentagon::Valid(){
	return V.size() == 5 && ((V[0].x - V[2].x)*(V[1].y - V[2].y) - (V[0].y - V[2].y)*(V[1].x - V[2].x)) != 0;
}
